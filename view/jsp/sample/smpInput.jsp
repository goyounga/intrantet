...
<ucare:table border="detail">
	<tr>
		<td class=MANTDT width=90 rowspan="19">text</td>
		<td class=MANTDM width=100>type</td>
		<td class=MANTDM width=150><ucare:input type="text"/></td>
		<td class=MANTDM>
	...
	<tr>
		...
		<td class=MANTDM>
			&lt;ucare:input type="checkbox" name="useyn" <font color="red">brcode="USEYN" code="code" codename="codenm" option="10"</font> checkcode="N"/&gt;
		</td>
		<td>
	...
	<tr>
		...
		<td class=MANTDM><ucare:input type="checkbox" name="useyn2" queryid="smpradio" code="code" codename="code_nm" checkcode="02" option="-1"/></td>
		<td class=MANTDM>
			&lt;ucare:input type="checkbox" name="useyn2" <font color="red">queryid="smpradio" code="code" codename="code_nm" option="-1"</font> checkcode="02"/&gt;
		</td>
		<td>
	...
	<tr>
		<td class=MANTDM>checkcode</td>
		<td class=MANTDM><ucare:input type="radio" name="myname2" value="1" checkcode="1"/></td>
		<td class=MANTDM>
			&lt;ucare:input type="radio" name="myname2" value="1" <font color="red">checkcode="1"</font>/&gt;
		</td>
		<td>
			value와 값이 같으면 checked=true로 설정한다.<br>
			추후 codebook에서 코드를 읽어와 checkbox를 만들어주는 로직을 추가할 예정임.<br>
	...
	<tr>
		<td class=MANTDM>쿼리ID 주기</td>
		<td class=MANTDM><ucare:input type="radio" name="rdoCntrcd" queryid="smpradio" code="code" codename="code_nm" checkcode="02" option="-1"/></td>
		<td class=MANTDM>
			&lt;ucare:input type="radio" name="rdoCntrcd" <font color="red">queryid="smpradio" code="code" codename="code_nm" option="-1"</font> checkcode="02"/&gt;
		</td>
		<td>
