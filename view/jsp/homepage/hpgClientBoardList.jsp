...
<%
	...
	try
	{
		...
		cParamSet.setParam("_SERVICE_ID"	, _SELECT_ID_LIST);
		...
		iDataSet.next();
		ds = iDataSet.getFindDataSet(_SELECT_ID_LIST);
...
function goPage(arg)
{
	fBoard._START_ROW.value = arg;
	fBoard.mode.value = "LIST";
 	fBoard.submit();
}
function viewContent(arg)
{
	fBoard.seq.value = arg;
	fBoard.mode.value = "VIEW";
 	fBoard.submit();
}
</script>
</head>
