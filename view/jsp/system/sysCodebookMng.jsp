			...
			<ucare:table type="query" width="1215">
				...
				<tr>
					...
					<td width="80"align=center>
						<ucare:imgbtn name="btnQuery" kind="R"  onClick="makeTree()" /><!-- 조회 -->
					</td>
				</tr>
			</ucare:table>
		</td>
										...
										<tr>
											<td>
												...
												<ucare:table type="detail" width="700">
													...
													<tr>
														<td class="MANTDT">코드</td>
														<td class="MANTDM">
															<input type=text class=input_required name=code style="width:130;" maxlength="10" required="true" requirednm="코드" onChange="codeChange(this.value)">
															<input type=text class=input_required name=orgcode size=0 style="display:none">
															<ucare:imgbtn name="btnCdDupChk" value="코드중복체크"  		onClick="codeDupChk()"/>
														</td>
													</tr>
													<tr>
														<td class="MANTDT">코드명</td>
														<td class="MANTDM">
															<input type=text class=input_required name=codenm style="width:565;" maxlength="100" required="true" requirednm="코드명">
														</td>
													</tr>
													<tr>
														<td class="MANTDT">기타1</td>
														<td class="MANTDM">
															<input type=text class=input_text name="etc1" maxlength="30" style="width:565;" required="false">
														</td>
													</tr>
													<tr>
														<td class="MANTDT">기타2</td>
														<td class="MANTDM">
															<input type=text class=input_text name="etc2" maxlength="30" style="width:565;" required="false">
														</td>
													</tr>
													<tr>
														<td class="MANTDT">기타3</td>
														<td class="MANTDM">
													...
													<tr>
														...
														<td class="MANTDM">
															<ucare:select name="useyn" brcode="COM001" code="code" codename="codenm" option="4" styleClass="combo_required" width="130" tag="required='true' requirednm='사용여부'"/>
														</td>
													</tr>
													<tr>
										...
										<tr>
											<td>
												...
												<table width="700" cellpadding="0" cellspacing="0" border="0">
													...
													<tr>
														<td align="left">
															<ucare:imgbtn name="btnCodeBook" value="서버반영" type="G" onClick="codereload();"	/>
														</td>
														<td align="right">
															<ucare:imgbtn name="btnheightAdd"	value="대분류등록"	onClick="heightAdd()"/>
															<ucare:imgbtn name="btnLowAdd"		value="소분류등록"	onClick="lowAdd()"/>
															<ucare:imgbtn name="btnMod"			value="수정"  		onClick="codeMod()"/>
