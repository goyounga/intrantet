...
function getMonth(flag)
{
	...
	*/
	...
	if (flag == "+" || flag == "-")
	{
		...
		if (index < 0 )
		{
		//20150109sjd달력 이전,이후버튼클릭시 반대로 데이터조회되어 수정
			if (f.year.selectedIndex != 0)
			{
				f.year.selectedIndex = 	f.year.selectedIndex-1;
				f.month.selectedIndex = 11;
...
function selfclose()
{
	parent.divCal.style.display = "none";
}
</script>
<body class="pbody" onload=getMonth("")>
<center>
<form name=f>
<table class="ptbl_outline" border="0" cellpadding="0" cellspacing="0"><tr><td height="228" valign="top">
	...
	<ucare:table id="UCCOMCALENDAR" rows="5"  type="list" width="240" height="110" scrollY="no">
		<tr>
	...
	<div style="position:absolute; left:235px; top:210px;"><img src="<%=scriptPath%>/images/slider/btn_delete02.gif" onClick="selfclose()" style="cursor:hand"></div>
	</form>
	</center>
</td></tr></table>
</body>
