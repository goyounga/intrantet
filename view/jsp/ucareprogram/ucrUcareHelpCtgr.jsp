...
<head>
	...
	<script language="javascript" src="/html/js/ucareprogram/ucrUcareHelpCtgr.js"></script>
</head>
				...
				<tr>
					...
					<td valign="top">
						<table width="600" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<td>
									<ucare:grid id="UCUCR300S" width="600" height="720" no="false">
										<tr event="O">
					...
					<td valign="top">
						<table width="600" cellpadding="0" cellspacing="0" border="0">
									...
									<ucare:table type="detail" width="600">
										...
										<tr>
											...
											<td class="MANTDM" colspan="3">
												<input type=text class="input_required" name="ctgr_nm" required="true" requirednm="카테고리명" style="width:502;" maxlength="100">
											</td>
										</tr>
										<tr>
											<td class="MANTDT" width="100">설명</td>
											<td class="MANTDM" width="390" colspan="3">
												<textarea class="input_required" name="ctgr_desc" style="width:502;height:180;" maxlength="500"></textarea>
											</td>
										</tr>
										<tr>
							...
							<tr>
								<td align="right">
									<ucare:imgbtn name="btnAdd"		value="등록"	onClick="ctgrAdd()"/><!-- 등록 -->
									<ucare:imgbtn name="btnSave"		value="저장"	onClick="ctgrSave()"/><!-- 저장 -->
									<ucare:imgbtn name="btnDel"		value="삭제"	onClick="ctgrDel()"/><!-- 삭제 -->
								</td>
							</tr>
						</table>
					</td>
