...
var INSERT_BOARD_ID		= "UCINF210I";		//게시판리스트 추가
var UPDATE_BOARD_ID		= "UCINF210U";		//게시판리스트 수정
var DELETE_BOARD_ID		= "UCINF210D";		//게시판리스트 삭제

var SELECT_GRD1_ID		= "UCINF211S";		//권한부여된 사용자등급 조회
var INSERT_GRD1_ID		= "UCINF211I";		//권한부여된 사용자등급 추가
var UPDATE_GRD1_ID		= "UCINF211U";		//권한부여된 사용자등급 수정
var DELETE_GRD1_ID		= "UCINF211D";		//권한부여된 사용자등급 삭제

var SELECT_GRD2_ID		= "UCINF212S";		//권한부여 안된 사용자등급
...
//					g_pop =  window.open("/jsp/system/sysBoardList.jsp?"+param, "popup", "toolbar=no,scrollbars=no,top=0,left=100,width=1010,height=700");				
