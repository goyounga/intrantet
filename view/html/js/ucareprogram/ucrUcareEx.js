var SELECT_EX_ID		= "UCUCR303S";		//Example 조회
var INSERT_EX_ID		= "UCUCR302I";		//Example 추가
var UPDATE_EX_ID		= "UCUCR302U";		//Example 수정
var DELETE_EX_ID		= "UCUCR302D";		//Example 삭제
...
function showDetailO_obj(id, strColumnKey, nRow)
{
	...
	switch(id)
	{
		...
		case SELECT_EX_ID:
			...
			//웹에디터 셋팅
			var ex_cont = f.ex_cont.value;
			editor_setHTML('ex_cont', ex_cont);
