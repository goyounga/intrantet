...
<ucare:table border="detail">
	...
	<tr>
		...
		<td class=MANTDM>
			&lt;ucare:select name="mycombo" <font color="red">queryid="samplecombobyquery"</font> brcode="" code="etc1" codename="codenm"/&gt;
		</td>
		<td>
	...
	<tr>
		...
		<td class=MANTDM><ucare:select name="mycombo" brcode="COM002" height="5" multiple="true"/></td>
		<td class=MANTDM>
			&lt;ucare:select name="mycombo" brcode="COM002" height="5" <font color="red">multiple="true"</font>/&gt;
		</td>
		<td>
	...
	<tr>
		...
		<td class=MANTDM><ucare:select name="mycombo" brcode="COM002" selCode="A"/></td>
		<td class=MANTDM>
			&lt;ucare:select name="mycombo" brcode="COM002" <font color="red">selCode="A"</font>/&gt;
		</td>
		<td>
			기본으로 선택할 코드를 지정한다.
		</td>
