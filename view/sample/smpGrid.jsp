...
<script language="javascript" src="js/smpGrid.js"></script>
</head>
...
<ucare:table type="detail" width="100%">
	...
	<tr>
		<td class="MANTDM">
			...
			- 마우스 더블 클릭	: <font color="red">&lt;tr event="D"&gt;</font> =&gt; function showDetail_obj(id, strColumnKey, nRow) { // 로직추가 } <br>
			...
			=&gt;  function showDetail_obj(id, strColumnKey, nRow) { // 로직추가 }<br>
			...
			- 동시에 마우스 왼쪽 클릭, 더블 클릭 주기 :  <font color="red">&lt;tr event="B"&gt;</font> <br>
			  기존 코딩방식을 따릅니다.<br>
			=&gt;  function showDetailC_obj(id, strColumnKey, nRow) { // 로직추가 }<br>
		...
		<td class="MANTDM">
			<ucare:grid id="grid12" width="450" height="120">
				<tr event="">
					...
					<td  width="100" column="code" title="소분류"></td>
					<td  width="100" column="codenm" title="코드명"></td>
					<td  width="100" column="useyn" title="사용여부" format="COMBO" brcode="USEYN" option="4" editable="true"></td>
				</tr>
			</ucare:grid>		
		</td>
	</tr>
	...
	<tr>
		<td class="MANTDM">
			<ucare:grid id="grid20" width="350" height="120">
				<tr event="">
					<td  width="100" column="uppercd" title="대분류" merge="true"></td>
					<td  width="100" column="code" title="소분류"></td>
					<td  width="100" column="codenm" title="코드명"></td>
				</tr>
			</ucare:grid>		
