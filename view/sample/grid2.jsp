...
<script language="javascript" src="js/grid2.js"></script>
</head>
...
<ucare:table type="detail" width="100%">
	...
	<tr>
		...
		<td class=MANTDM>
			<font color="blue">1. Grid를 사용하는 화면에는 무조건 onload에 eventGrid()함수를 추가 하세요.</font> <br> 
			 예) &lt;body onload="<font color="red">eventGrid()</font>"&gt; <br>
			<font color="blue">2. Tag 작성방법</font> <br> 
			예) <br>
			 &lt;ucare:grid <font color="red">id="SMPCODEBOOKS"</font> width="350" height="120"&gt; <br>
			 &nbsp;&nbsp;&nbsp;&nbsp;	&lt;tr event=""&gt; <br>
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		&lt;td  width="100" column="uppercd" title="대분류"&gt;&lt;/td&gt; <br>
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		&lt;td  width="100" column="code" title="소분류"&gt;&lt;/td&gt; <br>
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		&lt;td  width="100" column="codenm" title="코드명"&gt;&lt;/td&gt; <br>
			 &nbsp;&nbsp;&nbsp;&nbsp;	&lt;/tr&gt; <br>
			&lt;/ucare:grid&gt; <br>
			<font color="blue">3. javascript 작성방법</font> <br>
			function query() <br>
			{<br>
	...
	<tr>
		<td class="MANTDM">
			- 마우스 왼쪽 클릭	: <font color="red">&lt;tr event="O"&gt;</font> =&gt; function showDetail_obj(id, strColumnKey, nRow) { // 로직추가 } <br> 
			- 마우스 오른쪽 클릭: <font color="red">&lt;tr event="R"&gt;</font> =&gt; function showDetailR_obj(id, strColumnKey, nRow) { // 로직추가 }	<br> 
			- Cell Change: <font color="red">&lt;tr event="C"&gt;</font> =&gt; function showDetailC_obj(id, strColumnKey, nRow, vtOldValue, vtNewValue) { // 로직추가 }
		</td>
	</tr>
	...
	<tr>
		<td class="MANTDM">
			<ucare:grid id="grid11" width="350" height="120">
				<tr event="">
					<td  width="20" column="chk" title="선택" format="CHECKBOX" hcheckbox="true" editable="true"></td>
					<td  width="100" column="uppercd" title="대분류"></td>
					<td  width="100" column="code" title="소분류"></td>
					<td  width="100" column="codenm" title="코드명"></td>
				</tr>
		...
		<td class="MANTDM">
			<ucare:grid id="grid12" width="450" height="120">
				<tr event="">
					...
					<td  width="100" column="code" title="소분류"></td>
					<td  width="100" column="codenm" title="코드명"></td>
					<td  width="100" column="useyn" title="사용여부" format="COMBO" brcode="USEYN" editable="true"></td>
				</tr>
			</ucare:grid>		
		</td>
	</tr>
	<tr>
		<td class="MANTDM">
			...
			예) &lt;td  width="100" column="useyn" title="사용여부" <font color="red">format="COMBO" brcode="USEYN" editable="true"</font>&gt;&lt;/td&gt;
		</td>
	</tr>
	...
	<tr>
		<td class="MANTDM">
			<ucare:grid id="grid16" width="450" height="120">
				<tr event="">
					<td  width="100" column="uppercd" title="대분류"></td>
					<td  width="100" column="code" title="소분류"></td>
					<td  width="100" column="codenm" title="코드명"></td>
